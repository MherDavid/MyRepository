...
public class AppTest {
	...
	public void connectApp() throws MalformedURLException {
		...
		capabilities
				.setCapability("app",
						"/home/student/workspace/MyRepository/PhoneApp/bin/PhoneApp.apk");
	...
	/*
	 * public void text(@Named("ourText") String ourText, @Named("id") String
	 * id){ AndroidElement click = driver.findElement(By.id(id));
	 * click.sendKeys(ourText); } public void
	 * checkTextEditor(@Named("expectedText") String expectedText, @Named("id")
	 * String id){ try{ AndroidElement click = driver.findElement(By.id(id));
	 * String realText = click.getText(); Assert.assertEquals(expectedText,
	 * realText); } catch(Exception e) { e.printStackTrace(); } }
	 */
	@Test
